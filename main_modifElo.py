...
p.add_argument('-l', default = '1' , help='permet de définir le nombre de label que vous voulez attribuer au sommet, 1 = seulement les outils / 2 = on rajoute le numéro du wf d origine, par défaut 1', metavar = 'nb_labels')
p.add_argument('s', help = "output file name", metavar='output_name')
p.add_argument('-n',default ='True', help="pour gspan, true si un groupe rassemblant tous les notools ensembles, false sinon", metavar="groupe_notool")  #ajout elora
...
if os.path.exists(args.f) == False :
    ...
    if args.a == 'gspan' :
        ...
        for y in CompleteList:
            ...
            res =  pfg.Parsing_v_gspan(y, args.t, args.g,args.n)
