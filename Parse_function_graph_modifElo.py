...
Ensuite, on attribue le label en fonction de certain paramètre :
    ...
    (ii) Pour les process no_tools, le label sera identique pour tous (100000). -> 1000000
            ...
            for name in filenames :
                ...
                if name == "operations_extracted.json" :
                    ...
                    for operation in data :
                        ...
                        for i in range(100000, 100000+len(id_type_operation),1): #ajout 0
...
def dico_no_tools(dossier) :
    ...
    label_no_tools= 1000000 #ajout 0
                ...
                if name == "processes_info.json" :
                    ...
                    for process in data :
                        ...
                        if no_tools == 0 :
                            ...
                            for i in range(1000000, 1000000+len(dico_label_no_tools),1): #j'ai ajouté un 0
...
def Parsing_v_gspan(dossier,table_simi, graph_file, GrNoTool) :
                ...
                for n in g.nodes() :
                    ...
                    if n[0:9] != "OPERATION" and n[0:9] != '"OPERATIO' and n!= "in" and n!= "out":
                        ...
                        if val != False : #false quand notool
                            ...
                            id_sommet.append([n,nb_sommet, 1000000]) #j'ai ajouté un 0
                            nb_sommet +=1
                            ...
                            if n == "in" :
                                ...
                                #du type d'opération
                                for lab_ope in range(100000, 100000+len(label_ope),1) : #j'ai ajouté un 0
